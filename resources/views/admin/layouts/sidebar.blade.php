<div class="section-menu-left">
    ...
    <div class="section-menu-left-wrap">
        <div class="center">
            ...
            <div class="center-item">
                ...
                <li class="menu-item has-children {{ request()->is('admin/hero-section*') || request()->is('admin/about-section*') ? 'active' : '' }}">
    ...
    <ul class="sub-menu">
        <li class="sub-menu-item {{ request()->is('admin/hero-section*') ? 'active' : '' }}">
            <a href="{{ route('admin.hero.edit') }}">
                <div class="text">Hero Section</div>
            </a>
        </li>

        <li class="sub-menu-item {{ request()->is('admin/about-section*') ? 'active' : '' }}">
            <a href="{{ route('admin.about.edit') }}">
                <div class="text">About Section</div>
            </a>
        </li>

        <li class="sub-menu-item {{ request()->is('admin/testimonials*') ? 'active' : '' }}">
            <a href="{{ route('admin.testimonials.index') }}">
                <div class="text">Testimonials</div>
                    ...
                    <li class="menu-item has-children {{ request()->is('admin/products*') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-item-button">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item {{ request()->is('admin/products') ? 'active' : '' }}">
                                <a href="{{ route('admin.products.index') }}">
                                    <div class="text">Product List</div>
                                </a>
                            </li>

                            <li class="sub-menu-item {{ request()->is('admin/products/create') ? 'active' : '' }}">
                    ...
                    <li class="menu-item has-children {{ request()->is('admin/categories*') ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item {{ request()->is('admin/categories') ? 'active' : '' }}">
                                <a href="{{ route('admin.categories.index') }}">
                                    <div class="text">Category List</div>
                                </a>
                            </li>

                            <li class="sub-menu-item {{ request()->is('admin/categories/create') ? 'active' : '' }}">
