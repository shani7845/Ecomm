! function(e) {
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function() {
        ...
        if (e(".slider-area").length > 0 && e(".slider-area").closest(".container").parent().addClass("arrow-wrap"), t.hasClass("translateSlider")) {
            const u = {
                translate: .1,
                rotate: .01
            };
            ...
            function h() {
                requestAnimationFrame(h), document.querySelectorAll(".single").forEach((e => {
                    const t = e.getBoundingClientRect(),
                        a = .5 * window.innerWidth - (t.x + .5 * t.width);
                    let n = Math.abs(a) * u.translate - t.width * u.translate;
                    n < 0 && (n = 0);
                    const s = a < 0 ? "left top" : "right top";
                    e.style.transform = `translate(0, ${n}px) rotate(${-a*u.rotate}deg)`, e.style.transformOrigin = s
                }))
            }
            h()
        }
        ...
        e(".team2SliderAAAA").each((function() {
            const t = e(this),
                a = .2,
                n = .02,
                s = new Swiper(this, {
            ...
            ! function e() {
                requestAnimationFrame(e),
                    function() {
                        const e = t.find(".swiper-slide"),
                            o = s.activeIndex;
                        e.each((function(e, t) {
                            const s = t.getBoundingClientRect(),
                                i = .3 * window.innerWidth - (s.x + .3 * s.width);
                            let r = Math.abs(i) * a - s.width * a;
                            if (r < 0 && (r = 0), e === o) t.style.transform = "translate(0, 0) rotate(0deg)", t.style.transformOrigin = "center bottom";
                            else {
                                const e = Math.abs(i * n),
                                    a = i < 0 ? e : -e;
                                t.style.transform = `translate(0, ${r}px) rotate(${a}deg)`, t.style.transformOrigin = i < 0 ? "left bottom" : "right bottom"
                            }
                        }))
                    }()
            }()
        }))
    })), e(".menu-item-2").hover((function() {
        e(".menu-item-2").removeClass("active"), e(this).addClass("active")
    }), (function() {
    ...
    function f() {
        ...
        t = function() {
            ...
            function n(n) {
                n = n.split(",");
                for (var s = 0; s < n.length; s++) t = d + " " + n[s], e(t).val() ? (e(t).removeClass(p), a = !0) : (e(t).addClass(p), a = !1)
            }
    ...
    e(d).on("submit", (function(e) {
        ...
        e(this).each((function() {
            ...
            n = Math.floor(l.height() / 2), s = l.attr(t), o = l.attr(a), i = v(e(o).css("padding-top")), r = v(e(o).css("padding-bottom")), "top-half" === s ? (e(o).css("padding-bottom", r + n + "px"), l.css("margin-top", "-" + n + "px")) : "bottom-half" === s && (e(o).css("padding-top", i + n + "px"), l.css("margin-bottom", "-" + n + "px"))
        }))
    };
    var y = "[data-sec-pos]";
    ...
    e.fn.lettering = function(t) {
        return t && x[t] ? x[t].apply(this, [].slice.call(arguments, 1)) : "letters" !== t && t ? (e.error("Method " + t + " does not exist on jQuery.lettering"), this) : x.init.apply(this, [].slice.call(arguments, 0))
    ...
    function S() {
        P || (window.innerWidth > 991 ? (T || (T = new Lenis({
            lerp: .07,
            smooth: !0
        }), T.on("scroll", ScrollTrigger.update), A = gsap.ticker.add((e => {
            T && T.raf(1e3 * e)
        ...
        }))), T.start()) : (T && (T.stop(), T = null), A && (gsap.ticker.remove(A), A = null)))
    }
    if (S(), window.addEventListener("resize", (() => {
            S()
    ...
    e(document).ready((function() {
        ...
        e(".pricing-tabs").length && (t.on("click", (function() {
            n.prop("checked", !1), t.addClass("toggler--is-active"), a.removeClass("toggler--is-active"), s.removeClass("hide"), o.addClass("hide")
        })), a.on("click", (function() {
            n.prop("checked", !0), a.addClass("toggler--is-active"), t.removeClass("toggler--is-active"), s.addClass("hide"), o.removeClass("hide")
        })), n.on("click", (function() {
            a.toggleClass("toggler--is-active"), t.toggleClass("toggler--is-active"), s.toggleClass("hide"), o.toggleClass("hide")
        })))
    })), e(document).ready((function() {
        var t = e("#filt-monthly"),
            a = e("#filt-yearly"),
    ...
    /*
    window.addEventListener("resize", S), window.addEventListener("contextmenu", (function(e) {
        e.preventDefault()
